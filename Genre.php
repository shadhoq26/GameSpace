...
<h1 id="genretitle"> Genre </h1>
        ...
        <div id= "block2-container">
            <div class="block2" onclick = "location.href='GenreList.php?genre=Horror'" ><h1>Horror</h1><img src ="resources/genre images/horror.jpg"></div>
            <div class="block2" onclick = "location.href='GenreList.php?genre=RPG'" ><h1>RPG</h1><img src = "resources/genre images/rpg.jpg"></div>
            ...
            <div class="block2" onclick = "location.href='GenreList.php?genre=Battle Royale'" ><h1>Battle Royale</h1><img src = "resources/genre images/battleroyale.jpg"></div>           
        </div>   
    </div>
